...
var db                = new sqlite3.Database('x86.sqlite');
var intelX86RefParser = require('./intel-x86-ref-parser');

db.serialize(function() {
	db.run('CREATE TABLE instructions (mnemonic TEXT PRIMARY KEY, opcode TEXT, short_description TEXT, long_description TEXT, affected_flags TEXT)');
